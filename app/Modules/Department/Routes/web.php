...
// SHOW
    Route::get('/{id}', ['as' => 'department.show', 'uses' => 'DepartmentController@show'])->where('id', '[0-9]+');

// EDIT | UPDATE
    Route::get('/{id}/edit', ['as' => 'department.edit', 'uses' => 'DepartmentController@edit'])->where('id', '[0-9]+');
    Route::put('/{id}', ['as' => 'department.update', 'uses' => 'DepartmentController@update'])->where('id', '[0-9]+');

// DELETE
    Route::delete('department', ['as' => 'department.destroy', 'uses' => 'DepartmentController@destroy']);
    Route::get('/{id}/delete', ['as' => 'department.delete', 'uses' => 'DepartmentController@delete']);
